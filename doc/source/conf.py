# -*- coding: utf-8 -*-
#
# bjsonrpc documentation build configuration file, created by
...
project = u'bjsonrpc'
copyright = u'2010, David Martínez Martí'
...
htmlhelp_basename = 'bjsonrpc-doc'
...
latex_documents = [
  ('index', 'bjsonrpc.tex', u'bjsonrpc Documentation',
   u'David Martínez Martí', 'manual'),
]
